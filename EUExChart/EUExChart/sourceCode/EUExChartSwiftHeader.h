...
SWIFT_CLASS("_TtC12AppCanPlugin35BarLineScatterCandleBubbleChartData")
...
SWIFT_CLASS("_TtC12AppCanPlugin38BarLineScatterCandleBubbleChartDataSet")
...
- (void)drawDataWithContext:(CGContextRef __nullable)context;
- (void)drawValuesWithContext:(CGContextRef __nullable)context;
- (void)drawExtrasWithContext:(CGContextRef __nullable)context;

/// Draws all highlight indicators for the values that are currently highlighted.
///
/// \param indices the highlighted values
- (void)drawHighlightedWithContext:(CGContextRef __nullable)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
@end
...
- (nonnull instancetype)initWithDelegate:(id <BarChartRendererDelegate> __nullable)delegate animator:(ChartAnimator * __nullable)animator viewPortHandler:(ChartViewPortHandler * __nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef __nullable)context;
- (void)drawValuesWithContext:(CGContextRef __nullable)context;
- (void)drawExtrasWithContext:(CGContextRef __nullable)context;
- (void)drawHighlightedWithContext:(CGContextRef __nullable)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
...
@property (nonatomic) ChartHighlight * __nullable lastHighlighted;
...
/// Sets the formatter to be used for drawing the values inside the chart. If no formatter is set, the chart will automatically determine a reasonable formatting (concerning decimals) for all the values that are drawn inside the chart. Set this to nil to re-enable auto formatting.
...
@property (nonatomic) ChartXAxisRenderer * __nonnull xAxisRenderer;
...
@property (nonatomic) ChartYAxisRenderer * __nonnull leftYAxisRenderer;
...
@property (nonatomic) ChartYAxisRenderer * __nonnull rightYAxisRenderer;
@property (nonatomic, readonly) double chartYMax;
@property (nonatomic, readonly) double chartYMin;
...
- (nonnull instancetype)initWithDelegate:(id <BubbleChartRendererDelegate> __nullable)delegate animator:(ChartAnimator * __nullable)animator viewPortHandler:(ChartViewPortHandler * __nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef __nullable)context;
- (void)drawValuesWithContext:(CGContextRef __nullable)context;
- (void)drawExtrasWithContext:(CGContextRef __nullable)context;
- (void)drawHighlightedWithContext:(CGContextRef __nullable)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
...
@interface CALayer (SWIFT_EXTENSION(AppCanPlugin))
- (void)renderInOptionalContext:(CGContextRef __nullable)ctx;
@end
...
SWIFT_CLASS("_TtC12AppCanPlugin29LineScatterCandleChartDataSet")
...
SWIFT_CLASS("_TtC12AppCanPlugin35LineScatterCandleRadarChartRenderer")
...
- (void)drawHighlightLinesWithContext:(CGContextRef __nullable)context point:(CGPoint)point set:(LineScatterCandleChartDataSet * __nonnull)set;
@end
...
- (nonnull instancetype)initWithDelegate:(id <CandleStickChartRendererDelegate> __nullable)delegate animator:(ChartAnimator * __nullable)animator viewPortHandler:(ChartViewPortHandler * __nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef __nullable)context;
- (void)drawValuesWithContext:(CGContextRef __nullable)context;
- (void)drawExtrasWithContext:(CGContextRef __nullable)context;
- (void)drawHighlightedWithContext:(CGContextRef __nullable)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
...
- (void)renderAxisLabelsWithContext:(CGContextRef __nullable)context;

/// Draws the grid lines belonging to the axis.
- (void)renderGridLinesWithContext:(CGContextRef __nullable)context;

/// Draws the line that goes alongside the axis.
- (void)renderAxisLineWithContext:(CGContextRef __nullable)context;

/// Draws the LimitLines associated with this axis to the screen.
- (void)renderLimitLinesWithContext:(CGContextRef __nullable)context;
@end
...
typedef SWIFT_ENUM(NSInteger, ApproximatorType) {
    ...
    SWIFT_PROTOCOL("_TtP12AppCanPlugin24ChartXAxisValueFormatter_")
    ...
    /// An interface for providing custom x-axis Strings.
    SWIFT_CLASS("_TtC12AppCanPlugin31ChartDefaultXAxisValueFormatter")
...
/// Sets the x offset fo the legend. Higher offset means the legend as a whole will be placed further away from the left/right. Positive value will move the legend to the right when LTR, and to the left when RTL.
@property (nonatomic) CGFloat xOffset;

/// Sets the y offset fo the legend. Higher offset means the legend as a whole will be placed further away from the top.
@property (nonatomic) CGFloat yOffset;
...
- (void)renderLegendWithContext:(CGContextRef __nullable)context;
@end
...
- (void)drawWithContext:(CGContextRef __nullable)context point:(CGPoint)point;
...
@end
                        ...
                        SWIFT_CLASS("_TtC12AppCanPlugin10ChartRange")
...
@end
                        ...
                        SWIFT_CLASS("_TtC12AppCanPlugin20ChartSelectionDetail")
...
@property (nonatomic) id <ChartXAxisValueFormatter> __nullable valueFormatter;

/// the position of the x-labels relative to the chart
@property (nonatomic) enum XAxisLabelPosition labelPosition;

/// if set to true, word wrapping the labels will be enabled. word wrapping is done using (value width * labelWidth)
///
...
@end
                                    ...
                                    - (double)lineChartRendererChartYMax:(LineChartRenderer * __nonnull)renderer;
                                    - (double)lineChartRendererChartYMin:(LineChartRenderer * __nonnull)renderer;
                                    - (double)lineChartRendererChartXMax:(LineChartRenderer * __nonnull)renderer;
                                    - (double)lineChartRendererChartXMin:(LineChartRenderer * __nonnull)renderer;
                                    ...
                                    @interface CombinedChartRenderer : ChartDataRendererBase <BarChartRendererDelegate, ScatterChartRendererDelegate, CandleStickChartRendererDelegate, BubbleChartRendererDelegate, LineChartRendererDelegate>
...
- (nonnull instancetype)initWithDelegate:(id <LineChartRendererDelegate> __nullable)delegate animator:(ChartAnimator * __nullable)animator viewPortHandler:(ChartViewPortHandler * __nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef __nullable)context;
- (void)drawValuesWithContext:(CGContextRef __nullable)context;
- (void)drawExtrasWithContext:(CGContextRef __nullable)context;
- (void)drawHighlightedWithContext:(CGContextRef __nullable)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
...
/// the line break mode for center text. note that different line break modes give different performance results - Clipping being the fastest, WordWrapping being the slowst.
@property (nonatomic) NSLineBreakMode centerTextLineBreakMode;
...
- (nonnull instancetype)initWithDelegate:(id <ScatterChartRendererDelegate> __nullable)delegate animator:(ChartAnimator * __nullable)animator viewPortHandler:(ChartViewPortHandler * __nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef __nullable)context;
- (void)drawValuesWithContext:(CGContextRef __nullable)context;
- (void)drawExtrasWithContext:(CGContextRef __nullable)context;
- (void)drawHighlightedWithContext:(CGContextRef __nullable)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
